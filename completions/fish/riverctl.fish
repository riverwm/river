...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'get-focused-tags'       -d 'Show views with tags corresponding to the set bits of tags'
...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'get-view-tags'          -d 'Assign the currently focused view the tags corresponding to the set bits of tags'
